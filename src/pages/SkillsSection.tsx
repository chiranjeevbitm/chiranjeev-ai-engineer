    ...
    >
      <main className="pt-28 pb-stack-lg px-margin-mobile md:px-margin-desktop max-w-container-max mx-auto">
        ...
        <section className="grid grid-cols-1 md:grid-cols-12 gap-gutter mb-stack-lg">
          {/* GenAI & LLMs - with stagger effect on skill tags */}
          <motion.div variants={fadeIn} className="md:col-span-8 glass-card-light p-stack-md rounded-xl glow-hover-light">
            ...
            >
              {["Prompt Engineering","RAG Pipelines","LangChain","LangGraph","Agentic Systems","Multi-Agent Orchestration","Haystack","Hallucination Scoring"].map(s => (
                <motion.span
                  ...
                  className="px-3 py-1 bg-primary/5 border border-primary/20 text-primary dark:text-[#d0bcff] dark:border-[#d0bcff]/20 font-code-sm text-code-sm rounded-lg hover:bg-primary/20 transition-colors"
                >
                  {s}
                </motion.span>
              ))}
          ...
          {/* LLM Deployment */}
          <motion.div variants={fadeIn} className="md:col-span-4 glass-card-light p-stack-md rounded-xl glow-hover-light">
            <div className="flex items-center gap-stack-sm mb-stack-md">
            ...
            <ul className="space-y-stack-sm">
              {["Azure OpenAI","NVIDIA DGX","Azure AI Search","AWS / GCP Inference"].map((item, i) => (
                <motion.li
                  key={item}
                  ...
                  className="flex items-center gap-stack-sm font-code-sm text-code-sm text-[var(--on-surface-variant)]"
                >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-stack-md">
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {["Docker","Kubernetes","CI/CD","MLflow"].map((t, i) => (
                    <motion.span
                      key={t}
                      ...
                      whileHover={{ scale: 1.1 }}
                      className="px-2 py-0.5 border border-primary/20 font-code-sm text-code-sm rounded-lg bg-white/5 text-[var(--on-surface)] dark:border-[#d0bcff]/20 text-[var(--on-surface)]"
                    >
                      {t}
                    </motion.span>
                  ))}
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {["Dataiku","Vertex AI","Databricks"].map((p, i) => (
                    <motion.span
                      key={p}
                      initial={{ opacity: 0, scale: 0.8 }}
                      whileInView={{ opacity: 1, scale: 1 }}
