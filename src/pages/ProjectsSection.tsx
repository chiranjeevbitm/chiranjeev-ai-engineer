      ...
      <main className="pt-28 pb-stack-lg max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-gutter mb-20">
          {filtered.map((project) => (
            <div key={project.id} className="glass-card-light p-stack-md rounded-xl transition-all flex flex-col h-full group glow-hover-light">
        ...
        <section className="mb-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-stack-md">
            {githubRepos.map((repo) => (
              <div key={repo.name} className="bg-white/5 border border-primary/10 p-stack-md rounded-xl hover:border-primary/50 hover:bg-white/10 transition-all group dark:border-[#d0bcff]/10 dark:hover:border-[#d0bcff]/50">
                <div className="flex items-center justify-between mb-3">
        ...
        <section className="glass-card-light p-12 rounded-2xl border-primary/20 text-center relative overflow-hidden dark:border-[#d0bcff]/20">
