          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-gutter">
            <div className="md:col-span-2 glass-card-light p-10 rounded-xl glow-hover-light transition-all">
              ...
              <p className="font-body-md text-body-md text-on-surface-variant leading-relaxed">
                ...
                the delivery of GenAI COE projects. My focus lies in designing robust
                RAG pipelines, multi-agent frameworks, and ensuring responsible AI
                deployments across Azure, AWS, and NVIDIA DGX infrastructures.
              </p>
            </div>
